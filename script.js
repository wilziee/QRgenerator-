...
btnGenerate.addEventListener('click', () => {
    if (typeof QRCode === 'undefined') {
        showToast("❌ Tunggu sebentar, sistem sedang memuat library...");
        return;
    }

    const data = getQRData();
    if (!data) {
        showToast("⚠️ Mohon isi field terlebih dahulu.");
        return;
    }
    ...
    setTimeout(() => {
        // Render ke Canvas untuk PNG & Tampilan
